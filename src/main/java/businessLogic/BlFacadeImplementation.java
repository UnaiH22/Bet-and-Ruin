...
public class BlFacadeImplementation implements BlFacade {
	...
	@WebMethod
	public boolean registerUser(String username, String password, String eMail) throws NullParameterException, UserAlreadyTakenException, NotValidEmailException, AlreadyTakenEMailException 
	{
		dbManager.open(false);
